"""Stage 1 -- trains the MRI-to-CT regression model; output: a resumable checkpoint and CSV training log."""
...
def quick_validation(
    ...
    EMA-cold-start pitfall documented in PROJECT_NOTES.md (round 6): this validation
...
def main():
    ...
    if latest_ckpt is not None:
        ...
        ema.decay = train_cfg.get("ema_decay", 0.999)  # same re-apply-from-config fix as train_stage1.py (round 8) -- see PROJECT_NOTES.md
