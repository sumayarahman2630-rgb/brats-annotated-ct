...
def write_dataset_card(output_dir: str, run_info: dict, counts: dict) -> None:
    ...
    lines = [
        ...
        "sampling. See the source repository's PROJECT_NOTES.md for why this model was added "
        ...
        "repository's PROJECT_NOTES.md for what was verified about this specific checkpoint (val-set "
        ...
        "See that repository's PROJECT_NOTES.md for the full method and how this compares to the wavelet "
        "diffusion pipeline.",
        "",
    ]
