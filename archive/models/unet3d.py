...
# PROJECT_NOTES.md's "Known bugs fixed"). API moved between torch versions; support both.
try:
...
class ResBlock3D(nn.Module):
    ...
    def forward(self, x: torch.Tensor, emb: torch.Tensor) -> torch.Tensor:
        ...
        # -- see PROJECT_NOTES.md's "Known bugs fixed") around for backward, only x/emb are kept
