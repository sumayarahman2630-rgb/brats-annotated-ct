...
def write_dataset_card(output_dir: str, run_info: dict, counts: dict) -> None:
    ...
    lines = [
        ...
        f"DEVELOPMENT_LOG.md for the full architecture decision record.",
        ...
        "output. Check the source repository's DEVELOPMENT_LOG.md \"Known bugs fixed\" / status sections for "
        ...
        "repository's DEVELOPMENT_LOG.md for the full method, architecture decisions, and reference repos "
